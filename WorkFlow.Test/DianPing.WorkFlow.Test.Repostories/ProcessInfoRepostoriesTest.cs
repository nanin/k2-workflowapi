...
namespace DianPing.WorkFlow.Test.Repostories
{
    ...
    /// <summary>
    ///这是 ProcessInfoRepostoriesTest 的测试类，旨在
    ///包含所有 ProcessInfoRepostoriesTest 单元测试
    ///</summary>
    [TestClass()]
    public class ProcessInfoRepostoriesTest
    {
        ...
        public void GetByProcessCodeTest()
        {
            ...
            IList<string> processCodeLIst = new List<string>() { "TGContract" };
